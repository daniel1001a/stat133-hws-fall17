...
```{r}
#7
plot(experience, new_salary, main = "Scartterpolt with Lowess Smooth", xlab = "Years of Experience", lines(lowess(points,new_salary ), col = 10))
lines(lowess(experience, new_salary), lwd = 3, col = 70)
```
